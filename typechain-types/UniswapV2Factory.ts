...
export interface UniswapV2FactoryInterface extends Interface {
  ...
  encodeFunctionData(functionFragment: "PAIR_HASH", values?: undefined): string;
  encodeFunctionData(
  ...
  decodeFunctionResult(functionFragment: "PAIR_HASH", data: BytesLike): Result;
...
export interface UniswapV2Factory extends BaseContract {
  ...
  PAIR_HASH: TypedContractMethod<[], [string], "view">;
